...
cat prep-download-products.sh download-products.sh | ssh ubuntu@$CF_OPS_MAN_GUI_HOST -p $CF_OPS_MAN_GUI_SSH_PORT CF_PIVNET_TOKEN=$CF_PIVNET_TOKEN CF_BINARY_STORE=$script_destination "bash -s"
